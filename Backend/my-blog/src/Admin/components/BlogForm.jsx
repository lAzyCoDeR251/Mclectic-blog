...
const BlogForm = ({ selectedBlogId }) => {
  ...
  const fetchBlogData = async (blogId) => {
    try {
      const response = await axios.get(`${window.location.origin}/auth/blogs/${blogId}`);
    ...
    try {
      ...
      if (selectedBlogId) {
        ...
        response = await axios.put(
          `${window.location.origin}/auth/blogs/${selectedBlogId}`,
          blogContent,
          {
            headers: {
        ...
        response = await axios.post(
          `${window.location.origin}/auth/blogs`,
          blogContent,
          {
            headers: {
              "Content-Type": "application/json",
